...
**Action:** Always hoist invariant string operations (like `toLowerCase()`) or data parsing outside of iterative methods (`filter`, `map`, `sort`) to pre-calculate the value once per render cycle.
