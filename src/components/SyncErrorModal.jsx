      ...
      <div className="bg-white rounded-xl shadow-2xl w-full max-w-4xl h-[80vh] flex flex-col overflow-hidden border border-red-200">
        ...
        <div className="bg-red-50 p-6 border-b border-red-100 flex items-center gap-4">
          ...
          <div className="flex-1">
            <h2 className="text-2xl font-bold text-red-800">Sync Error Detected</h2>
            <p className="text-red-600">
              We encountered a problem syncing your data with the server.
            </p>
          </div>
        </div>
        ...
        {/* Footer */}
        <div className="bg-slate-50 p-6 border-t border-slate-200 flex flex-col sm:flex-row justify-end items-center gap-4">
          <button
            onClick={onDismiss}
