...
const DataManagement = ({ students, onImportSuccess }) => {
    ...
    return (
        <div className="max-w-5xl mx-auto px-3 md:px-6 lg:px-8 py-4 md:py-8">
            <div className="bg-[var(--bg-main)] rounded-none shadow-[4px_4px_0_0_rgba(255,255,255,0.2)] border border-[var(--border-color)] overflow-hidden page-enter">
                <div className="p-4 md:p-10 border-b border-[var(--border-color)] bg-[var(--bg-card)]">
                    <div className="flex flex-col md:flex-row items-start md:items-center gap-4 mb-2">
                        <div className="p-3 md:p-4 bg-[#CCFF00] text-black border border-[#CCFF00] rounded-none shadow-[4px_4px_0_0_rgba(255,255,255,0.2)] shrink-0">
                ...
                <div className="p-3 md:p-10 grid md:grid-cols-2 gap-4 md:gap-6">
                    <div className="group relative">
                        <div className="relative bg-[var(--bg-card)] p-4 md:p-8 rounded-none border border-[var(--border-color)] shadow-[4px_4px_0_0_rgba(255,255,255,0.2)] transition-colors hover:border-[#CCFF00] h-full flex flex-col group">
                            <div className="w-10 h-10 md:w-14 md:h-14 bg-transparent border border-[#CCFF00] text-[#CCFF00] rounded-none flex items-center justify-center mb-6 group-hover:bg-[#CCFF00] group-hover:text-black transition-colors shrink-0">
                    ...
                    <div className="group relative">
                        <div className="relative bg-[var(--bg-card)] p-4 md:p-8 rounded-none border border-[var(--border-color)] shadow-[4px_4px_0_0_rgba(255,255,255,0.2)] transition-colors hover:border-emerald-400 h-full flex flex-col group">
                            <div className="w-10 h-10 md:w-14 md:h-14 bg-transparent border border-emerald-400 text-emerald-400 rounded-none flex items-center justify-center mb-6 group-hover:bg-emerald-400 group-hover:text-black transition-colors shrink-0">
                ...
                <div className="px-4 pb-6 md:px-10 md:pb-12">
                    <div className="bg-[var(--bg-card)] rounded-none p-5 md:p-8 border border-[var(--border-color)]">
                        ...
                        <div className="flex flex-wrap gap-3">
                            {['id', 'name', 'class', 'section', 'rollNo', 'guardianName', 'admissionDate', 'admissionStatus', 'feesAmount', 'feesStatus', 'feeHistory'].map(field => (
                                <code key={field} className="px-3 py-1.5 bg-[var(--bg-main)] border border-[var(--border-color)] rounded-none text-[10px] font-medium text-[#CCFF00]  shadow-[4px_4px_0_0_rgba(255,255,255,0.2)]">
                                    {field}
                                </code>
                            ))}
                        </div>
