        ...
        <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-8 max-w-4xl mx-auto">
            ...
            <div className="mt-8 bg-slate-50 rounded-xl p-6 border border-slate-200">
                ...
                <div className="flex flex-wrap gap-2">
                    {['id', 'name', 'class', 'section', 'rollNo', 'guardianName', 'phone', 'email', 'address', 'age', 'admissionNumber', 'admissionDate', 'admissionStatus', 'feesAmount', 'feesStatus', 'fine', 'feeHistory', 'tcDetails'].map(field => (
