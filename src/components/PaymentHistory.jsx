                    ...
                    <div key={student.id} className="bg-white p-4 rounded-xl border border-slate-200 shadow-sm">
                        <div className="flex justify-between items-start mb-3">
                            ...
                            <div className="text-right">
                                ...
                                <p className="font-bold text-emerald-600 text-lg">₹{getTotalPaid(student).toLocaleString()}</p>
                            </div>
                        </div>

                        <div className="flex items-center justify-between pt-3 border-t border-slate-50">
                            <span className="text-sm text-slate-500">
                                Last Payment: <span className="font-medium text-slate-700">{getLastPaymentDate(student)}</span>
                            </span>
                            <button
                                onClick={() => handleViewHistory(student)}
                                className="px-3 py-1.5 rounded-lg bg-indigo-50 text-indigo-600 text-xs font-bold uppercase tracking-wider border border-indigo-100"
                            >
                                View History
                            </button>
                        </div>
